...
[TestChart(0)]
public class Example4 : ExecuteBase
{
...
workload;
";
    public static void Workload(int param1, int param2, float param3)
    {
    }


    public override bool Static => true;
    public override string Method => "void Workload(int, int, float);";
